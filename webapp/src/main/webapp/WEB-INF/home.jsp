...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/login/css/jumbotron-narrow.css">
    <link rel="stylesheet" type="text/css" href="/login/css/home.css">
    <link rel="stylesheet" type="text/css" href="/login/css/jquery.growl.css"/>
    ...
    <div class="header clearfix">
        <nav>
            <ul class="nav nav-pills pull-right">
                <li class="active" id="home"><a href="/WEB-INF/index.html">Home</a></li>
                <li id="logout"><a href="/budget/logout">Logout</a></li>
            </ul>
        </nav>
        <h3 class="text-muted">PedzaceStrusie.com</h3>
    </div>
    <div class="jumbotron">
        <h3>Hello ${userId}!</h3>
    </div>
