...
public class GetExpensesByMonthServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        try {
            template = TemplateProvider.createTemplate(getServletContext(), "get-expenses-by-months.ftlh");
        } catch (IOException e) {
            logger.error("Template get-expenses-by-months is not found {}", e.getMessage());
        }
    }
